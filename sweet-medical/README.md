...
Sistema de gestión de turnos médicos: pacientes, médicos, agendas, planes y notificaciones. Backend en Node.js/Express con MongoDB, frontend en Next.js, tests unitarios (Jest) y end-to-end (Cypress), desplegado en producción sobre Docker.

Trabajo Práctico — UTN FRBA (2026). Proyecto grupal.
